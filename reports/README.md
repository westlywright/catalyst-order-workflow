...
- Group with prefixes: `TEST_`, `PERFORMANCE_`, `CHAOS_`, `SECURITY_`
- Markdown format: All reports end in `.md`

### Examples
- `TEST_RESULTS_2024-01-15.md`
- `CHAOS_CIRCUIT_BREAKER_ANALYSIS.md`
- `PERFORMANCE_BULK_ORDER_BENCHMARK.md`
- `IMPLEMENTATION_RETURNS_WORKFLOW.md`
